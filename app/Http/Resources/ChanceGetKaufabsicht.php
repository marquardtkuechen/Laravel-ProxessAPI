...
class ChanceGetKaufabsicht
{
    ...
    public function __construct($jsonObject) {
        ...
        foreach ($jsonObject['value'] as $key => $valueItem) {
            $chanceGetKaufabsichtValue = new ChanceGetKaufabsichtValue($valueItem);
            array_push($this->valueList, $chanceGetKaufabsichtValue->toArray());
...
class ChanceGetKaufabsichtValue {
    private $erpFremdKey;
    private $sort;
    private $value;
